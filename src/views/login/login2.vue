            ...
            >
              ...
              <el-form-item label="验证码">
                ...
                <a href="javascript:void(0);" class="getVecodeBtn">
                  <el-button style="margin: 0" v-show="show" size="medium" type="primary" @click="setSmsCode">获取验证码</el-button>
...
.contain {
  ...
  .content {
    ...
    .sm-bg {
      ...
      width: 795px;
      height: 406px;
      background-image: url("../../assets/img/sm_bg2.png");
      background-size: 100% 100%;
    }
  }
